                            ...
                            <li class="grid-item">
                                <div
                                    ...
                                    <div class="blog-image">
                                        <a href=""
                                           class="d-block"><img src="{{asset('storage/'.$blog?->cover_image)}}"
                                                                alt="{{$blog?->title}}"/></a>
                                        <div class="blog-categories">
                                            <a href=""
                                               class="categories-btn bg-white text-dark-gray text-dark-gray-hover text-uppercase fw-700">{{$blog?->category?->name}}</a>
                                        </div>
                                    </div>
                                    <div class="card-body p-12 lg-p-10">
                                        <a href=""
                                           class="card-title mb-15px fw-700 fs-19 text-dark-gray d-inline-block w-100 md-w-100">{{$blog?->short_title}}</a>
                                        ...
                                        <div
                                            ...
                                            <div class="me-auto">
                                                    <span
                                                        class="blog-date d-inline-block fw-700 text-dark-gray">{{$blog?->created_at->format('d/m/Y')}}</span>
                                                <div class="d-inline-block author-name fw-700 text-dark-gray">Uzman
                                                    Diyetisyen Ayşe Yılmaz
                                                </div>
                                            </div>
                                        </div>
                                    </div>
